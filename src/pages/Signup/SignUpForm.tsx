...
const SignUpForm = () => {
  ...
  return (
    <Box borderWidth={1} borderRadius="md" p={4} margin="auto" mt={20} mb={20} boxShadow="sm" width="fit-content">
          ...
          <FormControl>
            <Flex flexDirection="column" w={[280, 450]}>
              ...
              {validationError.hasError && (
                <ErrorUI errorTitle="Validation Error" errorDescription={validationError.errorMessage} />
              )}
              ...
              />
              <Text fontSize="xs" textColor="primary.600">
                *Password must include at least 1 special character
              </Text>
              <Text fontSize="xs" textColor="primary.600">
                *Password must include at least 1 numeric digit
              </Text>
              <Text fontSize="xs" textColor="primary.600">
                *Password must include at least 1 uppercase and lowercase character
              </Text>
              <Input
                required
                id="confirmpassword"
              ...
              <Button colorScheme="primary" bgColor="primary.600" mt={8} borderRadius={0} type="submit">
